...
const Category = () => {
    return (
        <section>
            ...
            ></SectionTitle>
            <Swiper slidesPerView={4} spaceBetween={30} centeredSlides={true} pagination={{ clickable: true, }}  modules={[Pagination]} className="mySwiper mb-24">
                <SwiperSlide>
                    <img src={slide1} alt="" />
                ...
                <SwiperSlide>
                    <img src={slide4} alt="" />
                    <h3 className='text-4xl text-center uppercase text-white -mt-16'>Dessert</h3>
                </SwiperSlide>
                <SwiperSlide>
                    <img src={slide5} alt="" />
                    <h3 className='text-4xl text-center uppercase text-white -mt-16'>Salads</h3>
