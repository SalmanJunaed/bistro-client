                ...
                <div className="card md:w-1/2 w-full max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleLogin} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <button type='button' className="btn btn-outline btn-xs mt-4">Validate</button>
                        </div>
                    ...
                    <p className='text-center py-6'>
                        <small>New Here?<Link  to='/signup'><span className='font-bold text-blue-600'>Create an Account</span></Link></small>
                    </p>
